<ul class="c-sidebar-nav">
    ...
    @can('manage users')
        <li class="c-sidebar-nav-item">
            {{-- {{ route('users.index') }} --}}
            <a class="c-sidebar-nav-link {{ request()->is("users/*") ? "c-active" : "" }}" href="#">
    ...
    <li class="c-sidebar-nav-item">
        ...
        <a class="c-sidebar-nav-link {{ request()->is("projects/*") ? "c-active" : "" }}" href="#">
    ...
    <li class="c-sidebar-nav-item">
        {{-- {{ route('tasks.index') }} --}}
        <a class="c-sidebar-nav-link {{ request()->is("tasks/*") ? "c-active" : "" }}" href="#">
